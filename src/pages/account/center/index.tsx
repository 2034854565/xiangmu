import { PlusOutlined, HomeOutlined, ContactsOutlined, ClusterOutlined, DoubleRightOutlined } from '@ant-design/icons';
import { Avatar, Card, Col, Divider, Input, Row, Tag, Tabs, List } from 'antd';
...
import { getLikeInfo, getStoreInfo } from './service';
  ...
  return (
    <GridContent>
      <Row gutter={24}>
        ...
        <Col lg={17} md={24}>
          <div style={{ backgroundColor: 'white', minHeight: 900 }}>
