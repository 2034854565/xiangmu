...
const SupervisionCreate: React.FC<{}> = () => {
  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <div className={styles.title}>日常督察信息录入</div>
        <div style={{ marginTop: 20 }}>
          ...
          >
            ...
            <ProFormDatePicker name="time" label="时间" colProps={{ span: 12 }} placeholder='' />
            <ProFormSelect
              colProps={{ span: 12 }}
              label="单位"
              name="unit"
            ...
            />
            <ProFormTextArea name="remark" label="考核事项及评价说明" colProps={{ span: 12 }} placeholder='' />
            <ProFormUploadDragger name="content" max={1} label="上传附件" colProps={{ span: 12 }}/>

            <div className={styles.infoTitle}>各单位补充工序名称</div>
            <ProFormSelect
              colProps={{ span: 12 }}
              label="工序"
              name="procedure"
            ...
            <div className={styles.infoTitle}>考核申诉</div>
            <ProFormTextArea name="suggest" label="申诉处理意见" colProps={{ span: 20 }} labelCol={{ span: 4 }} placeholder='' />

            <div className={styles.infoTitle}>工艺部组织沟通后定输出考核项</div>
            <ProFormText name="department" label="输出考核" colProps={{ span: 8 }} placeholder='' />
            <ProFormText name="department" label="考核分数" colProps={{ span: 8 }} placeholder='' />
            <ProFormText name="department" label="考核全额" colProps={{ span: 8 }} placeholder='' />

            <div className={styles.infoTitle}>各单位补充被考核人信息</div>
            <ProFormText name="department" label="被考核人工号" colProps={{ span: 12 }} placeholder='' />
            <ProFormText name="department" label="被考核人姓名" colProps={{ span: 12 }} placeholder='' />
...
export default SupervisionCreate;
